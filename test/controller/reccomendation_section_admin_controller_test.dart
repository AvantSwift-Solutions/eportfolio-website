...
void main() {
  ...
  setUp(() {
    ...
    when(mockReccomendation1.rid).thenReturn('rid123');
    ...
    when(mockReccomendation2.rid).thenReturn('rid321');
  ...
  test('getReccomendationSectionData returns correct data when reccomendation is not null',
    ...
    expect(recc1.rid, mockReccomendation1.rid);
    ...
    expect(recc2.rid, mockReccomendation2.rid);
