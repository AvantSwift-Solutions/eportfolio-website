...
void main() {
  group('Awards & Certification Section Widget Test', () {
    ...
    group('Awards & Certification Section Widget Test on Mobile', () {
      testWidgets('Award Cert Section displays expected data on Mobile',
          (WidgetTester tester) async {
      ...
      // testWidgets(
      //     'Award Cert Circle inside of Award Cert Section works properly on Mobile',
      //     (WidgetTester tester) async {
      //   // Set the screen size to be Vertical (i.e. have a 1080x1920 aspect ratio)
