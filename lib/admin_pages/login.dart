...
class LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      if ((screenWidth > LoginPage.responsiveWidthLimit) &&
          (screenHeight > LoginPage.responsiveHeightLimit)) {
        return Scaffold(
          ...
          children: [
            Align(
              ...
              child: Text(
                ...
                style: PublicViewTextStyles.generalHeading.copyWith(
                  fontSize:
                      screenWidth * LoginPage.headingResponsiveSizingFactor,
                ),
              ),
            ),
            Row(
                  ...
                  child: Text(
                    ...
                    style: PublicViewTextStyles.generalHeading.copyWith(
                      fontSize: screenWidth *
                          LoginPage.subHeadingResponsiveSizingFactor,
                    ),
                  ),
                ),
                const SizedBox(
